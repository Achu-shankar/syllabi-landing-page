...
- `.doc` - Legacy Word (requires backend)

### Upload Process

1. **Content** tab → **Upload Document**
...
- Use online tools: [pdf2doc.com](https://pdf2doc.com)
...
1. **Fetch metadata**: Title, description, duration
2. **Download transcript**: Auto-generated or manual captions
...
2. File sent to transcription service (AssemblyAI)
