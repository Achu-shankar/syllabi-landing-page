            ...
            >
                ...
                >
                    <div className="w-full  text-center lg:text-left ">
                        ...
                        >
                            <SectionTitle>
                                <h3 className="lg:max-w-2xl gradient-text">
                                    {title}
                                </h3>
                            </SectionTitle>
                ...
                <div className={clsx("mt-5 lg:mt-0 relative", { "lg:order-2": imageAtRight })}>
                    <div className={clsx("w-fit flex relative", { "justify-start": imageAtRight, "justify-end": !imageAtRight })}>
                        {/* Gradient glow behind image */}
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-400 via-orange-400 to-blue-400 rounded-2xl blur-2xl opacity-20"></div>
                        {/* Glass container for image */}
                        <div className="relative glass rounded-2xl p-2 border border-purple-100 hover:border-purple-200 transition-all shadow-xl hover:shadow-2xl">
                            <Image src={imageSrc} alt="title" width="600" height="450" quality={100} className="lg:ml-0 rounded-xl w-full h-auto" />
                        </div>
                    </div>
                </div>
            </motion.div>
